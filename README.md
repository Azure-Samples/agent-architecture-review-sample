...
| **Deploy command** | `.\scripts\windows\deploy.ps1 -target webapp -AppName arch-review-web` | `azd ai agent deploy` or `.\scripts\windows\deploy.ps1 -target agent` |
...
```bash
# Install/update Azure Developer CLI
